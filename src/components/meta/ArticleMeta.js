...
const ArticleMetaGhost = ({ data, settings, canonical, customScripts: CustomScripts }) => {
    ...
    <Fragment>
      <Helmet>
        ...
        <meta
          ...
          content={
            ghostPost.twitter_description || ghostPost.excerpt || ghostPost.meta_description
          }
        />
